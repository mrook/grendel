{
  ...
  @lastmod($Id: winsock2.pas,v 1.4 2002/08/03 19:18:03 ***REMOVED*** Exp $)
...
type
    TSockAddr6 = record
      ...
      sin6_addr : TSockAddrIn6;
    end;

type
    TSockAddr_Storage = record
      ss_family : short;
      ss_pad1 : array[0..5] of char;
      ss_align: int64;
      ss_pad2 : array[0..112] of char;
    end;
...
function bind( const s: TSocket; var addr: TSockAddr; const namelen: Integer ): Integer; stdcall;
function closesocket( const s: TSocket ): Integer; stdcall;
function connect( const s: TSocket; var name: TSockAddr; namelen: Integer): Integer; stdcall;
...
function WSALookupServiceBeginA( const lpqsRestrictions : LPWSAQuerySetA; const dwControlFlags : DWORD; lphLookup : PHANDLE ): Integer; stdcall;
function WSALookupServiceBeginW( const lpqsRestrictions : LPWSAQuerySetW; const dwControlFlags : DWORD; lphLookup : PHANDLE ): Integer; stdcall;
function WSALookupServiceBegin( const lpqsRestrictions : LPWSAQuerySet; const dwControlFlags : DWORD; lphLookup : PHANDLE ): Integer; stdcall;
function WSALookupServiceNextA( const hLookup : THandle; const dwControlFlags : DWORD; var lpdwBufferLength : DWORD; lpqsResults : LPWSAQuerySetA ): Integer; stdcall;
function WSALookupServiceNextW( const hLookup : THandle; const dwControlFlags : DWORD; var lpdwBufferLength : DWORD; lpqsResults : LPWSAQuerySetW ): Integer; stdcall;
function WSALookupServiceNext( const hLookup : THandle; const dwControlFlags : DWORD; var lpdwBufferLength : DWORD; lpqsResults : LPWSAQuerySet ): Integer; stdcall;
